            ...
            properties: {
                pattern: {
                    ...
                    description:
                        ...
                        "Ejemplo: 'asjClaude', 'export default', 'import Anthropic'",
                },
                path: {
                    type: "string",
                    description:
                        "Directorio donde buscar, relativa al proyecto (ej: './src', './src/llm'). " +
                ...
                file_extension: {
                    ...
                    description:
                        ...
                        "Si se omite, busca en todos los tipo de archivo.",
                },
            },
            required: ["pattern"],
        },
